...
<div id="container">
	<div id="row">
		<?php
			...
			if ($params->get('filename_field')) $head .= '<div id="value"><h3>&nbsp;'.JText::_('MOD_XBT_TRACKER_FIELD_FILENAME_FIELD_LABEL').'&nbsp;</h3><hr /></div>';
			...
			if ($params->get('created_time_field')) $head .= '<div id="value-center"><h3>&nbsp;'.JText::_('MOD_XBT_TRACKER_FIELD_CREATED_TIME_FIELD_LABEL').'&nbsp;</h3><hr /></div>';
			...
			if ($params->get('number_files_field')) $head .= '<div id="value"><h3>&nbsp;'.JText::_('MOD_XBT_TRACKER_FIELD_NUMBER_FILES_FIELD_LABEL').'&nbsp;</h3><hr /></div>';
			...
			if ($params->get('download_button') && TrackerHelper::user_permissions('can_leech', $user->id) ) $head .= '<div id="value-center"><h3>&nbsp;'.JText::_('MOD_XBT_TRACKER_FIELD_DOWNLOAD_BUTTON_VIEW').'&nbsp;</h1><hr /></div>';
			$head .= '</div>';
			...
			foreach ($list as $item) {
				...
				if ($params->get('created_time_field')) $items .= '<div id="value-right">&nbsp;'.date('Y.m.d', strtotime($item->created_time)).'&nbsp;<hr /></div>';
				...
				if ($params->get('number_files_field')) $items .= '<div id="value-center">&nbsp;'.$item->number_files.'&nbsp;<hr /></div>';
				...
				if ($params->get('license_field')) $items .= '<div id="value-center">&nbsp;'.$item->torrent_license.'&nbsp;<hr /></div>';
