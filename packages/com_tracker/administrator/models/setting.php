...
class TrackerModelSetting extends JModelAdmin {
	...
	public function save() {
		...
		$settings['anonymous_announce'] 			= (int)$data['anonymous_announce'];
		$settings['anonymous_scrape'] 				= (int)$data['anonymous_scrape'];
		$settings['auto_register'] 						= (int)$data['auto_register'];
