...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_tracker&task=countries.saveOrderAjax&tmpl=component';
	...
	<div id="j-main-container" class="span10">
		...
		<table class="table table-striped" id="countryList">
			<thead>
				...
				<th class="nowrap left">
					<?php echo JHtml::_('grid.sort',  'COM_TRACKER_NAME', 'a.name', $listDirn, $listOrder); ?>
				</th>

				<th class="nowrap">
					<?php echo JHtml::_('grid.sort',  'COM_TRACKER_COUNTRY_IMAGE', 'a.image', $listDirn, $listOrder); ?>
				</th>
			...
			?>
				...
				<td>
				<?php
					if ($canEdit) echo "<a href=".JRoute::_('index.php?option=com_tracker&task=country.edit&id='.(int) $item->id).">".$this->escape($item->name)."</a>";
					else echo $item->name;
				?>
				</td>
				
				<td><?php echo '<img id="flag'.$item->id.'" alt="'.$item->name.'" src="'.JUri::root().$item->image.'" width="36" />'; ?></td>
