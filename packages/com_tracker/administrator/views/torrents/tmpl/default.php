...
<form action="<?php echo JRoute::_('index.php?option=com_tracker&view=torrents'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
		...
		<table class="table table-striped" id="torrentList">
			<thead>
				<tr>
				...
				<th width="10%" class="center nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort',  'JCATEGORY', 'a.categoryID', $listDirn, $listOrder); ?>
				</th>

				<th width="10%" class="center nowrap hidden-phone">
					<?php echo JHtml::_('grid.sort',  'COM_TRACKER_TORRENT_SIZE', 'a.size', $listDirn, $listOrder); ?>
				</th>

				<th width="10%" class="nowrap">
					<?php echo JHtml::_('grid.sort', 'COM_TRACKER_TORRENT_UPLOADED', 'a.created_time', $listDirn, $listOrder); ?>
				</th>

				<th width="10%" class="center nowrap">
					<?php echo JHtml::_('grid.sort', 'COM_TRACKER_TORRENT_LEECHERS_SMALL', 'a.leechers', $listDirn, $listOrder); ?>
				</th>

				<th width="10%" class="center nowrap">
					<?php echo JHtml::_('grid.sort', 'COM_TRACKER_TORRENT_SEEDERS_SMALL', 'a.seeders', $listDirn, $listOrder); ?>
				</th>

				<th width="10%" class="center nowrap">
					<?php echo JHtml::_('grid.sort', 'COM_TRACKER_TORRENT_COMPLETED_SMALL', 'a.completed', $listDirn, $listOrder); ?>
				</th>
