...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_tracker&task=comments.saveOrderAjax&tmpl=component';
	...
	<div id="j-main-container">
		...
		<table class="table table-striped" id="commentList">
			<thead>
				...
				<th class="nowrap">
					<?php echo JHtml::_('grid.sort',  'JGLOBAL_FIELD_CREATED_BY_LABEL', 'a.username', $listDirn, $listOrder); ?>
				</th>
