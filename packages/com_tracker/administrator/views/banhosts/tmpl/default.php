...
<form action="<?php echo JRoute::_('index.php?option=com_tracker&view=banhosts'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php endif;?>
		...
		<table class="table table-striped" id="banhostList">
			<thead>
				<tr>
				...
				<th class="nowrap left">
					<?php echo JHtml::_('grid.sort',  'COM_TRACKER_BANHOST_BEGIN', 'a.begin', $listDirn, $listOrder); ?>
				</th>

				<th class="nowrap">
					<?php echo JHtml::_('grid.sort',  'COM_TRACKER_BANHOST_END', 'a.end', $listDirn, $listOrder); ?>
				</th>

				<th class="nowrap">
					<?php echo JHtml::_('grid.sort',  'COM_TRACKER_BANHOST_COMMENT', 'a.comment', $listDirn, $listOrder); ?>
				</th>

				<th class="nowrap">
					<?php echo JHtml::_('grid.sort',  'COM_TRACKER_BANHOST_CREATED_USER_ID', 'a.created_user_id', $listDirn, $listOrder); ?>
				</th>

				<th class="nowrap">
					<?php echo JHtml::_('grid.sort',  'COM_TRACKER_BANHOST_CREATED_TIME', 'a.created_time', $listDirn, $listOrder); ?>
				</th>
			...
			?>
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'banhosts.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
