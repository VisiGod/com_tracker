...
if ($this->params->get('number_torrents') || $this->params->get('number_files') || $this->params->get('total_seeders') || $this->params->get('total_leechers') || $this->params->get('total_completed') || $this->params->get('bytes_shared')) {
...
if (($this->params->get('top_downloaders') && count($this->item->top_downloaders)) || ($this->params->get('top_uploaders') && count($this->item->top_uploaders)) || ($this->params->get('top_sharers') && count($this->item->top_sharers)) || ($this->params->get('worst_sharers') && count($this->item->worst_sharers))) {
	...
	if ($this->params->get('top_downloaders') && count($this->item->top_downloaders)) {
		...
		foreach ($this->item->top_downloaders as $item) {
			...
			echo '<div id="value-center">&nbsp;<img style="vertical-align:middle;" id="tdcountry<'.$item->uid.'" alt="'.$item->countryName.'" src="'.JURI::base().'media/com_tracker/flags/'.$item->countryImage.'" width="32px" /></div>';
	...
	if ($this->params->get('top_uploaders') && count($this->item->top_uploaders)) {
		...
		foreach ($this->item->top_uploaders as $item) {
			...
			echo '<div id="value-center">&nbsp;'.TrackerHelper::make_size($item->uploaded).'&nbsp;</div>';
			//if (empty($item->country)) $item->country = TrackerHelper::getCountryFlag($this->params->get('defaultcountry'));
			echo '<div id="value-center">&nbsp;<img style="vertical-align:middle;"  id="tdcountry<'.$item->uid.'" alt="'.$item->countryName.'" src="'.JURI::base().'media/com_tracker/flags/'.$item->countryImage.'" width="32" /></div>';
			echo '<div id="value-center">&nbsp;'.$item->usergroup.'&nbsp;</div>';
			echo '</div>';
		}
		echo '</div>';
	...
	if ($this->params->get('top_sharers') && count($this->item->top_sharers)) {
		...
		foreach ($this->item->top_sharers as $item) {
			...
			echo '<div id="value-center">&nbsp;'.TrackerHelper::make_size($item->downloaded).'&nbsp;</div>';
			echo '<div id="value-center">&nbsp;'.TrackerHelper::make_size($item->uploaded).'&nbsp;</div>';
			echo '<div id="value-center">&nbsp;'.TrackerHelper::get_ratio_color($item->uploaded/$item->downloaded).'&nbsp;</div>';
			//if (empty($item->country)) $item->country = TrackerHelper::getCountryFlag($this->params->get('defaultcountry'));
			echo '<div id="value-center">&nbsp;<img style="vertical-align:middle;"  id="tdcountry<'.$item->uid.'" alt="'.$item->countryName.'" src="'.JURI::base().'media/com_tracker/flags/'.$item->countryImage.'" width="32" /></div>';
			echo '<div id="value-center">&nbsp;'.$item->usergroup.'&nbsp;</div>';
			echo '</div>';
...
if (($this->params->get('most_active_torrents') && count($this->item->most_active_torrents)) || ($this->params->get('most_seeded_torrents') && count($this->item->most_seeded_torrents)) || ($this->params->get('most_leeched_torrents') && count($this->item->most_leeched_torrents)) || ($this->params->get('most_completed_torrents') && count($this->item->most_completed_torrents))) {
	...
	if ($this->params->get('most_active_torrents') && count($this->item->most_active_torrents)) {
		echo JHtml::_('tabs.panel', JText::_('COM_TRACKER_STATS_MOST_ACTIVE_TORRENTS'), 'most_active');
		...
		foreach ($this->item->most_active_torrents as $item) {
			...
			if (TrackerHelper::user_permissions('download_torrents', $session->get('user')->id, 1))
				echo '<a href="index.php?option=com_tracker&amp;task=torrent.download&amp;id='.$item->fid.'">'.$item->name.'</a>';
			else echo $item->name;
			echo '&nbsp;</div>';
	...
	if ($this->params->get('most_seeded_torrents') && count($this->item->most_seeded_torrents)) {
		echo JHtml::_('tabs.panel', JText::_('COM_TRACKER_STATS_MOST_SEEDED_TORRENTS'), 'most_seeded');
		echo '<br /><div id="container">';
		echo '<div id="row">';
		echo '<div id="value-center"><b>&nbsp;'.JText::_('COM_TRACKER_STATS_NAME').'&nbsp;</b></div>';
		echo '<div id="value-center"><b>&nbsp;'.JText::_('COM_TRACKER_STATS_SIZE').'&nbsp;</b></div>';
	...
	if ($this->params->get('most_leeched_torrents') && count($this->item->most_leeched_torrents)) {
		echo JHtml::_('tabs.panel', JText::_('COM_TRACKER_STATS_MOST_LEECHED_TORRENTS'), 'most_leeched');
		echo '<br /><div id="container">';
		echo '<div id="row">';
		echo '<div id="value-center"><b>&nbsp;'.JText::_('COM_TRACKER_STATS_NAME').'&nbsp;</b></div>';
		echo '<div id="value-center"><b>&nbsp;'.JText::_('COM_TRACKER_STATS_SIZE').'&nbsp;</b></div>';
	...
	if ($this->params->get('most_completed_torrents') && count($this->item->most_completed_torrents)) {
		echo JHtml::_('tabs.panel', JText::_('COM_TRACKER_STATS_MOST_COMPLETED_TORRENTS'), 'most_completed');
		echo '<br /><div id="container">';
		echo '<div id="row">';
		echo '<div id="value-center"><b>&nbsp;'.JText::_('COM_TRACKER_STATS_NAME').'&nbsp;</b></div>';
		echo '<div id="value-center"><b>&nbsp;'.JText::_('COM_TRACKER_STATS_SIZE').'&nbsp;</b></div>';
